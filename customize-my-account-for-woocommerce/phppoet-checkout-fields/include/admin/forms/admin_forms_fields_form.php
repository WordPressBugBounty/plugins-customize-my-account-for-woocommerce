...
<center>
	...
	<div class="alert alert-primary" role="alert">
		<?php echo esc_html__('Click on Add Form Field button to add new field Form.To manage existing fields visit settings tab.To Add new fields visit Edit Account Fields tab','customize-my-account-for-woocommerce'); ?>
	</div>
	...
	<div class="buttondiv">
		...
		<button type="button" href="#" data-etype="additional" id="wcmamtx_add_field2" class="btn btn-primary" >
			...
			<?php echo esc_html__('Add Fields Form','customize-my-account-for-woocommerce'); ?>
		</button>
