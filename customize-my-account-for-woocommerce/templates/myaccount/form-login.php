...
$_skip_guest  = ( isset( $_GET['skip_guest_dashboard'] ) && $_GET['skip_guest_dashboard'] === 'yes' );
if ( $_skip_guest ) {
    $frontend_url = add_query_arg( 'skip_guest_dashboard', 'yes', $frontend_url );
}

$_wcmamtx_layout     = wcmamtx_get_layout();
$_lp_headline = !empty( $_wcmamtx_layout['login_page_headline'] )   ? $_wcmamtx_layout['login_page_headline']   : '';
$_lp_subtitle = !empty( $_wcmamtx_layout['login_page_subtitle'] )   ? $_wcmamtx_layout['login_page_subtitle']   : '';
$_lp_badge    = !empty( $_wcmamtx_layout['login_page_badge_text'] ) ? $_wcmamtx_layout['login_page_badge_text'] : '';
?>

<div class="wc-auth-container wcmamtx_custom_login_register wcmamtx_login_popup_modal">

    <div class="wc-auth-split">

        <!-- LEFT PANEL -->
        <div class="wc-auth-left">
            <div class="wc-auth-blob wc-auth-blob-1"></div>
            <div class="wc-auth-blob wc-auth-blob-2"></div>
                ...
                <div class="wc-auth-tabs wcmamtx_login_register_buttons">
                    <button class="btn btn-login wc-tab-btn active" data-tab="login">
                        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M15 3H6C4.89543 3 4 3.89543 4 5V19C4 20.1046 4.89543 21 6 21H15" stroke="currentColor" stroke-width="2"/>
                    ...
                    <?php if ( 'yes' === get_option( 'woocommerce_enable_myaccount_registration' ) ) { ?>
                        <button class="btn btn-register wc-tab-btn" data-tab="register">
                            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <path d="M3 20C3 16.134 6.13401 13 10 13C13.866 13 17 16.134 17 20" stroke="currentColor" stroke-width="2" stroke-linecap="round"/>
                ...
                <div class="wcmamtx_login_boxes wc-tab-content wcmamtx_login active" id="login">
                    ...
                    <form class="woocommerce-form woocommerce-form-login login" method="post" action="<?php echo $frontend_url; ?>" novalidate>
                        ...
                        <p class="form-row">
                            ...
                            <?php if ( $_skip_guest ) : ?><input type="hidden" name="redirect" value="<?php echo esc_url( $frontend_url ); ?>"><?php endif; ?>
                            ...
                            <a href="<?php echo esc_url( wcmamtx_get_google_login_url() ); ?>" class="google-login-btn">
                                <span class="google-icon">
                                    <svg width="22" height="22" viewBox="0 0 48 48">
                                        <path fill="#EA4335" d="M24 9.5c3.54 0 6.74 1.22 9.25 3.6l6.9-6.9C35.96 2.42 30.42 0 24 0 14.64 0 6.56 5.38 2.62 13.22l8.04 6.24C12.6 13.5 17.84 9.5 24 9.5z"/>
                                        <path fill="#4285F4" d="M46.5 24.55c0-1.64-.15-3.22-.42-4.73H24v9.18h12.67c-.55 2.96-2.22 5.47-4.74 7.16l7.36 5.72c4.3-3.96 6.8-9.8 6.8-17.33z"/>
                                        <path fill="#FBBC05" d="M10.66 28.54A14.47 14.47 0 0 1 9.5 24c0-1.57.27-3.09.76-4.54l-8.04-6.24A24.02 24.02 0 0 0 0 24c0 3.87.93 7.53 2.58 10.78l8.08-6.24z"/>
                                        <path fill="#34A853" d="M24 48c6.48 0 11.92-2.14 15.89-5.82l-7.36-5.72c-2.04 1.37-4.66 2.18-8.53 2.18-6.15 0-11.38-4-13.34-9.42l-8.08 6.24C6.53 42.62 14.62 48 24 48z"/>
                                    </svg>
                                </span>
