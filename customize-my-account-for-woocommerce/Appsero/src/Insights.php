...
class Insights {
    ...
    public function admin_notice() {
        ...
        $policy_url = 'https://wcmamtx_Appsero.com/privacy-policy/';
    ...
    public function add_weekly_schedule( $schedules ) {
        $schedules['weekly'] = array(
            ...
            'display'  => __( 'Once Weekly', 'wcmamtx_Appsero' ),
        );
                ...
                <div class="wd-dr-modal-body">
                    ...
                    <p class="wd-dr-modal-reasons-bottom">
                        ...
                        echo sprintf(
                            ...
                            esc_url( 'https://wcmamtx_Appsero.com/' ),
                            esc_url( 'https://wcmamtx_Appsero.com/privacy-policy' )
                        );
                        ?>
                    </p>
                </div>
