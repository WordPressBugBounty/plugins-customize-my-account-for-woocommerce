...
<table class="widefat wcmamtx_options_table">
	...
	<tr>
		<td><label><?php echo esc_html__('Allow users to upload own avatar','customize-my-account-for-woocommerce'); ?></label> <br />
		</td>
		<td>
	...
	<tr>
		...
		<td>
			...
			<input type="range" min="96" max="200" value="<?php if (isset($avatar_settings['avatar_size']) ) { echo $avatar_settings['avatar_size']; } else { echo '96'; } ?>" name="<?php  echo esc_html__($this->wcmamtx_avatar_settings_page); ?>[avatar_size]">
