...
<table class="widefat wcmamtx_options_table">
	...
	<tr id="wcmamtx_custom_content_textarea_tr" class="wcmamtx_show_avatar_content_tr" style="<?php if (isset($avatar_settings['custom_avatar_content']) && ($avatar_settings['custom_avatar_content'] == "yes")) { echo 'display:table-row;'; } else { echo 'display:none;'; } ?>">
		...
		<td>
			<?php 
			$editor_content = isset($avatar_settings['content_avatar']) ? $avatar_settings['content_avatar'] : '<p class="wcmamtx_default_text_below_avatar" style="text-align: center;">Hello <strong>{display_name}</strong> (not <strong>{display_name}</strong>? <a href="{user_logout_link}">Log out</a>)</p>';
