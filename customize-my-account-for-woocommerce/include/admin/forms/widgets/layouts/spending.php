<table>  
    ...
    <tr class="nav_header_widget_tr" style="">
        <td><label><?php echo esc_html__('Spending box location priority on dashboard','customize-my-account-for-woocommerce'); ?></label> <br />
        </td>
        <td>
            <input type="number" class="" name="<?php  echo esc_html__($this->wcmamtx_layout_page); ?>[spendingbox_dashboard_priority]" value="<?php echo $spendingbox_dashboard_priority; ?>">
    ...
    <tr class="nav_header_widget_tr" style="">
        <td><label><?php echo esc_html__('Spending chart location priority on dashboard','customize-my-account-for-woocommerce'); ?></label> <br />
        </td>
        <td>
            <input type="number" class="" name="<?php  echo esc_html__($this->wcmamtx_layout_page); ?>[spendingchart_dashboard_priority]" value="<?php echo $spendingchart_dashboard_priority; ?>">
