...
?>
<div class="wcmam-dashboard-grid">
    ...
    if (($wcmamtx_type != "group") && ($should_show == 'yes') && ( $is_visible == "yes")) {
        ...
        <a href="<?php echo wcmamtx_get_account_endpoint_url( $key ); ?>" class="wcmam-dashboard-card <?php echo esc_attr( $key ); ?>">
            <div class="wcmam-card-icon">
                <?php 
