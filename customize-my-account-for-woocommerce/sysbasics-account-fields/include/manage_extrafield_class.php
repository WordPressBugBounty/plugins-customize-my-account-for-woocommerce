...
class syscmafwpl_manage_extrafield_class_free {
	...
	public function syscmafwpl_core_override_default_navigation_template($template,$template_name,$template_path) {
        ...
        if ( strstr($template, 'form-edit-account.php') ) {
            $template = wcmamtx_plugin_path() . '/sysbasics-account-fields//include/templates/form-edit-account.php';
        }
...
new syscmafwpl_manage_extrafield_class_free();
?>